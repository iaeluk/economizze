    ...
    <>
      <main className="flex flex-col items-center justify-center gap-16 min-w-full min-h-screen bg-black text-white">
        ...
        <div className="flex flex-col gap-3">
          <input id="valor" className="bg-black outline-none border-2 border-white rounded-md p-3 font-bold text-lg text-center" type="number" value={!valorInput ? '': valorInput} onChange={(e) => setValorInput(e.target?.value)} />
          <button className="bg-green-700 rounded-md p-4" onClick={() => {
